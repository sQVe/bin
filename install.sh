...
ln -s /home/sqve/.bin/gitkraken-start.sh /usr/local/bin/gitkraken-start
ln -s /home/sqve/.bin/i3exit.sh /usr/local/bin/i3exit
ln -s /home/sqve/.bin/load-icc.sh /usr/local/bin/load-icc
...
ln -s /home/sqve/.bin/private/twitch/index.coffee /usr/local/bin/twitch
